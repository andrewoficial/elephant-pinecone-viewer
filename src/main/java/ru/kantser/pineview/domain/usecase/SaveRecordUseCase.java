...
public class SaveRecordUseCase {
    ...
    public CompletableFuture<Void> save(String id, String text, Map<String, Object> metadata, int dimensions, String base_name) {
        //base_name == general_provisions
        return saveToIndex(base_name, id, text, metadata, dimensions);
    }

    public CompletableFuture<Void> saveToIndex(String indexName, String id, String text, Map<String, Object> metadata) {
        // Подготовка метаданных (опционально)
        ...
        // Вызываем вставку текста – Pinecone сама сгенерирует вектор
        return recordPort.upsertTextRecord(indexName, id, text, finalMetadata)
                .exceptionally(ex -> {
    ...
    @Deprecated
    public CompletableFuture<Void> saveToIndex(String indexName, String id, String text, Map<String, Object> metadata, int dimensions) {
        ...
        return CompletableFuture.supplyAsync(() -> {
                ...
                .thenCompose(vector -> {
                    ...
                    float[] def = new float[dimensions];
                    def[1] = 0.005F;
